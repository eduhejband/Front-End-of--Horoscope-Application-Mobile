...
const AstrologerDetailScreen = ({ navigation, route }) => {
    ...
    const aboutAstologersList = [
        `Olá! Meu nome é ${item.astrologerName}, e sou um astrólogo com mais de 10 anos de experiência em astrologia natal, sinastria e trânsitos. Ao longo dos anos, tive o privilégio de guiar inúmeras almas através dos mistérios do cosmos, ajudando-as a descobrir seus potenciais ocultos, superar desafios e abraçar seu destino cósmico.`,
