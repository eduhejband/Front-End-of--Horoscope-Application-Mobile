        ...
        return (
            <View style={{}}>
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Os cancerianos, com sua natureza intuitiva e cuidadosa, têm uma abordagem mais conservadora e estratégica para alcançar a riqueza.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Os cancerianos são conhecidos por sua natureza sensível, emocional e carinhosa. No amor, eles buscam segurança, conforto e uma conexão profunda.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Cancerianos precisam ter maior cuidado com doenças relacionadas a dores de cabeça, erupções no rosto e na cabeça, a vertigem, as nevralgias, a congestão cerebral, a encefalite e a meningite. O planeta Marte, regente de Áries, predispõe a ferimentos, golpes, queimaduras inflamações, febres elevadas e acidentes.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description:'Protetor e intuitivo, Câncer valoriza conexões familiares e tem uma natureza cuidadosa e empática.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Água: Representa emoções profundas, intuição e compreensão.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Lua: Simboliza emoções, instintos e o lado feminino. Reflete a natureza mutável e sensível de Câncer.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Quartzo Verde para cura, Ametista para calma, Âmbar para proteção e Pedra da Lua para equilíbrio emocional.',
