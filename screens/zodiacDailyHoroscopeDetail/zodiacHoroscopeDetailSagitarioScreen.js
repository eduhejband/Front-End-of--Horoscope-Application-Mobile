    ...
    function loveLuckHealthAndMoneyInfo() {
        return (
            <View style={{}}>
                ...
                {progressBarWithPercentage({ title: 'Amor', percentage: 75, startColor: '#FFAAAA', endColor: Colors.redColor })}
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Os sagitarianos, com sua natureza expansiva e mente aberta, têm uma abordagem aventureira em relação à riqueza. São naturalmente atraídos por oportunidades que lhes permitam expandir seus horizontes, seja através de viagens, educação ou empreendedorismo. ',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Os sagitarianos são conhecidos por sua natureza aventureira, otimista e independente. No amor, eles buscam um parceiro que possa compartilhar suas paixões e seu amor pela liberdade.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Sagitarios precisam se preocupar com doenças que dizem respeito às nádegas e as coxas, problemas no nervo ciático; as fraturas do fêmur são relacionadas com Marte e Saturno; os problemas do sangue e do fígado ocasionados por excessos alimentares.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Aventureiro, honesto e otimista. Busca conhecimento e liberdade.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Fogo: Energético, apaixonado e dinâmico. Sempre em movimento.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Júpiter: Expansão, sorte e filosofia. Busca crescimento e aprendizado.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Turquesa para proteção, Ametista para espiritualidade e Granada para paixão.',
