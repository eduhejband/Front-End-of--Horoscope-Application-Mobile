        ...
        return (
            <View style={{}}>
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Os capricornianos, com sua ética de trabalho inabalável e natureza ambiciosa, são frequentemente vistos como os "trabalhadores" do zodíaco. Eles têm uma abordagem estratégica e de longo prazo para as finanças e são conhecidos por serem prudentes e econômicos.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Os capricornianos são conhecidos por sua natureza prática, determinada e muitas vezes reservada. No amor, eles buscam estabilidade, lealdade e uma parceria que os apoie em seus objetivos de vida.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Capricornianos precisam ter mais cuidado com doenças que dizem respeito aos ossos, dentes, pele e cabelo, o reumatismo das articulações, os problemas nos joelhos e os problemas ocasionados pelo frio. O Planeta regente é Saturno. Dependendo do planeta e do aspecto podemos ter erupções cutâneas, quebra de joelhos e reumatismo.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Prático, disciplinado e ambicioso. Capricórnio busca estabilidade e tem uma abordagem realista da vida.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Terra: Representa a praticidade, estabilidade e a conexão com o mundo material.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Saturno simboliza restrição, disciplina e responsabilidade. Ele ensina as lições mais difíceis da vida.',
                ...
                {loveLuckHealthAndMoneyDetail({
                    ...
                    description: 'Hematita para aterramento, Turmalina para proteção e Ônix para força e resistência.',
